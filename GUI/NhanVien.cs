...
namespace QuanLyJewelry.GUI
{
    public partial class frmNhanVien : Form
    {
        ...
        private void reset()
        {
            ...
            NhanVienBLL.Instance.Xem(dtgvNhanVien);
        ...
        {
            QuyenBLL.Instance.getDataQuyen(cbQuyen);
            NhanVienBLL.Instance.Xem(dtgvNhanVien);
        }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            nv.MaQuyen = QuyenBLL.Instance.getMaQuyen(cbQuyen.Text) ?? 0;
            nv.SoDienThoai = txtSDT.Text;

            string check = NhanVienBLL.Instance.Them(nv);
            switch (check)
            {
                case "errorManv":
        ...
        {
            if (NhanVienBLL.Instance.Xoa(dtgvNhanVien))
            {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            string check = NhanVienBLL.Instance.Sua(nv, nv.SoDienThoai, nv.Email, nv.CCCD);
            switch (check)
            {
                case "errorManv":
                    MessageBox.Show("Mã nhân viên không được để trống!", "Error");
