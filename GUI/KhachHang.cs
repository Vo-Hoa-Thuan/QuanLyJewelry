...
namespace QuanLyJewelry.GUI
{
    public partial class frmKhachHang : Form
    {
        ...
        private void LoadDanhSachKhachHang()
        {
            try
            {
                DataTable dt = KhachHangBLL.Instance.LayTatCaKhachHang();
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (isEditMode)
                {
                    ...
                    result = KhachHangBLL.Instance.CapNhatKhachHang(kh);
                    if (result) { MessageBox.Show("Cập nhật thành công"); LoadDanhSachKhachHang(); ResetForm(); }
                }
                else
                {
                    result = KhachHangBLL.Instance.ThemKhachHang(kh);
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                bool result = KhachHangBLL.Instance.XoaKhachHang(id);
        ...
        private void txtTimKiem_TextChanged(object sender, EventArgs e)
        {
            ...
            DataTable dt = string.IsNullOrEmpty(keyword)
                ? KhachHangBLL.Instance.LayTatCaKhachHang()
                : KhachHangBLL.Instance.TimKiemKhachHang(keyword);
            dgvKhachHang.DataSource = dt;
            FormatDataGridView();
        }
        ...
        private void HienThiSanPhamDaMua(int khachHangId)
        {
            try
            {
                DataTable dtSanPham = KhachHangBLL.Instance.LaySanPhamDaMua(khachHangId);
