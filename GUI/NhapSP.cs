...
namespace QuanLyJewelry.GUI
{
    public partial class frmNhapSP : Form
    {
        ...
        private void reset()
        {
            ...
            SanPhamBLL.Instance.Xem(dtgvDSSP);
        }
        ...
        {
            LoaiHangBLL.Instance.getDataLoaiHang(cbLoaiSP);
            SanPhamBLL.Instance.Xem(dtgvDSSP);
        }
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            string check = SanPhamBLL.Instance.Them(sp);
        ...
        {
            if (SanPhamBLL.Instance.Xoa(dtgvDSSP))
            {
...

        {
            ...
            string check = SanPhamBLL.Instance.Sua(sp);
        ...
        {
            SanPhamBLL.Instance.Tim(dtgvDSSP, txtTimKiem.Text);
        }
