...
namespace QuanLyJewelry.GUI
{
    public partial class frmGiaoDich : Form
    {
        ...
        private void LoadKhachHang()
        {
            try
            {
                DataTable dt = GiaoDichBLL.Instance.LayDanhSachKhachHang();
        ...
        private void LoadNhanVien()
        {
            try
            {
                DataTable dt = GiaoDichBLL.Instance.LayDanhSachNhanVien();
        ...
        private void LoadSanPham()
        {
            try
            {
                DataTable dt = GiaoDichBLL.Instance.LayDanhSachSanPham();
        ...
        private void btnLuuDonHang_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Gọi Business Layer
                bool result = GiaoDichBLL.Instance.TaoDonHang(gd, listCT);
        ...
        private void dgvChiTiet_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
                ...
                dgvChiTiet.Rows[e.RowIndex].Cells["colMaSP"].Value != null)
            {
                try
                {
                    ...
                    decimal giaBan = GiaoDichBLL.Instance.LayGiaSanPham(maSP);
